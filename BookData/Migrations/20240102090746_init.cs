...
namespace BookData.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "Author", "BookType", "ISBN", "PublicationDate", "PublisherId", "Title" },
                values: new object[,]
                {
                    { 1, "Ayn Rand", 2, "123141412", 2000, 1, "Atlas Zbuntowany" },
                    { 2, "Stanisław Lem", 1, "5443332154", 2003, 2, "Solaris" }
                });
